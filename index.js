...
connection.onLogs(mintAddress,(data)=>{
    ...
    .then(transaction=>{
        ...
        chats.forEach(chat => {
            ...
            `<b>Buyer :</b><a href="https://explorer.solana.com/address/${receiver}?cluster=devnet">${receiver}</a>\n<b>Amount :</b><b>${amount}</b>\n<b>Bought:</b><b>${time.toString()}</b>\n<b>Signature :</b><a href="https://explorer.solana.com/tx/${data.signature}?cluster=devnet">View on Explorer</a>`
            ,{parse_mode:"HTML"})
